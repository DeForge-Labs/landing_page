...
export default function PrivacyPolicy() {
  return (
    <Container className="py-12 md:py-20 px-4 sm:px-20 relative">
      <div className="prose prose-neutral max-w-4xl mx-auto prose-headings:font-bold prose-h1:text-4xl prose-h2:text-2xl prose-h3:text-xl prose-a:text-blue-600 hover:prose-a:text-blue-800 prose-ul:list-disc prose-li:marker:text-black/50">
        <div className="text-center mb-12 border-b border-dashed border-black/20 pb-12">
        ...
        <div className="space-y-8 text-black/80 leading-relaxed">
          <section>
            <p className="mb-4">
              This Privacy Notice for Deforge ({"we"}, {"us"}, or {"our"}),
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>
                Use Deforge. A node based visual editor for creating and
                deploying AI agents.
              </li>
          ...
          <section
            id="summary"
            className="p-6 bg-secondary/30 rounded-xl border border-black/10"
          >
            <h2 className="text-2xl font-bold text-black mb-4 mt-0">
            ...
            <div className="space-y-4 text-sm sm:text-base">
              ...
              <p>
                ...
                <a
                  href="https://app.termly.io/notify/594102fa-34dc-4b6d-b60d-3404e2c81829"
                  rel="noopener noreferrer"
                  target="_blank"
                  className="text-blue-600 hover:underline"
                >
          ...
          <section
            id="toc"
            className="py-6 border-y border-dashed border-black/20"
          >
            <h2 className="text-2xl font-bold text-black mb-4">
              TABLE OF CONTENTS
            </h2>

            <ul className="space-y-1 text-sm sm:text-base font-medium text-black/70">
              <li>
                <a
                  href="#infocollect"
          ...
          <section id="infocollect">
            ...
            <p className="mb-4">
              ...
              Paddle and Paypal. You may find their privacy notice link(s) here:{" "}
              <a
            ...
            <p className="mb-4">
              When you grant us access to your Google account for specific
              functionalities, we securely store the access tokens for the
              scopes you have authorized. These tokens are exclusively used to
              operate the Deforge workflows or AI agents that you create and
              configure. The tokens are bound to these specific agents/workflows
              and are only utilized during their execution. We do not use these
              access tokens for any purpose outside of the designated
              workflows/agents you have built.
            </p>
          </section>
          ...
          <section id="ai">
            ...
            <p className="mb-4">
              ...
              ("AI Service Providers"), including Anthropic, ElevenLabs, Google
              Cloud AI and OpenAI. As outlined in this Privacy Notice, your
          ...
          <section id="infominors">
            ...
            <p className="mb-4">
              ...
              jurisdiction has been collected, we will deactivate the account
              ...
              from children under age 18 or the equivalent age as specified by
              law in your jurisdiction, please contact us at support@deforge.io.
            </p>
          </section>
          ...
          <section id="privacyrights">
            ...
            <p className="mb-4">
              ...
              may email us at support@deforge.io.
            </p>
          </section>
          ...
          <section id="uslaws">
            ...
            <div className="overflow-x-auto rounded-lg border border-black/50">
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-secondary/20">
                    <th className="border border-black/20 p-3 text-left font-bold text-black">
                      Category
                    </th>
                    <th className="border border-black/20 p-3 text-left font-bold text-black">
                      Examples
                    </th>
                    <th className="border border-black/20 p-3 text-center font-bold text-black">
                      Collected
                    </th>
                  </tr>
                </thead>
                ...
                <tbody>
                  <tr>
                    <td className="border border-black/20 p-3 align-top font-medium">
                      A. Identifiers
                    </td>
                    <td className="border border-black/20 p-3 align-top text-muted-foreground">
                      Contact details, such as real name, alias, postal address,
                      telephone or mobile contact number, unique personal
                      identifier, online identifier, Internet Protocol address,
                      email address, and account name
                    </td>
                    <td className="border border-black/20 p-3 align-top text-center font-bold text-black">
                      YES
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td className="border border-black/20 p-3 align-top text-muted-foreground"></td>
                    <td className="border border-black/20 p-3 align-top text-center font-bold text-black">
                      NO
                    </td>
                  </tr>
            ...
            <p className="mb-4">
              ...
              , by emailing us at support@deforge.io, or by referring to the
            ...
            <h3 className="text-xl font-semibold text-black mb-3">Appeals</h3>

            <p className="mb-4">
              Under certain US state data protection laws, if we decline to take
              action regarding your request, you may appeal our decision by
              emailing us at support@deforge.io. We will inform you in writing
          ...
          <section id="contact">
            ...
            <p className="mb-4">
              ...
              us at support@deforge.io or contact us by post at:
            </p>
