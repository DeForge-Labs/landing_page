...
const TermsOfService = () => {
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-black/10">
      <header className="sticky top-0 z-50 w-full border-b border-dashed border-black/50 bg-background/80 backdrop-blur-md">
        <Container
        ...
        >
          <div className="flex items-center gap-4">
            <Link
              href="/"
              className="flex items-center justify-center w-8 h-8 rounded-full border border-black/20 hover:bg-black/5 transition-colors"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl text-black">Deforge</span>
            </div>
          </div>
        </Container>
      </header>
          ...
          <div className="prose prose-neutral max-w-4xl mx-auto prose-headings:font-bold prose-h1:text-4xl prose-h2:text-2xl prose-h3:text-xl prose-a:text-blue-600 hover:prose-a:text-blue-800 prose-ul:list-disc prose-li:marker:text-black/50">
            ...
            <div className="space-y-8 text-black/80 leading-relaxed">
              <section>
                ...
                <p className="mb-4">
                  We are Deforge ("<strong>Company</strong>," "
                  <strong>we</strong>," "<strong>us</strong>," "
                  <strong>our</strong>"), a company registered in India at
                  Barrackpore, Kolkata, West Bengal 700120.
                </p>
                ...
                <p className="mb-4">
                  We provide a node based visual editor for creating and
                  deploying AI agents.
                </p>
                ...
                <p className="mb-4">
                  ...
                  <strong>you</strong>"), and Deforge, concerning your access to
                ...
                <p className="mb-4">
                  ...
                  support@deforge.io, as stated in the email message. By
              ...
              <section className="py-6 border-y border-dashed border-black/20">
              ...
              <section id="ip">
                ...
                <p className="mb-4">
                  ...
                  contact@deforge.io. If we ever grant you the permission to
              ...
              <section id="subscriptions">
                ...
                <p className="mb-4">
                  ...
                  Services, please email us at contact@deforge.io.
                </p>
              ...
              <section id="ppno">
                ...
                <p className="mb-4">
                  ...
                  Please be advised the Services are hosted in Germany. If you
                  ...
                  Germany, then through your continued use of the Services, you
                  are transferring your data to Germany, and you expressly
                  consent to have your data transferred to and processed in
                  Germany. Further, we do not knowingly accept, request, or
              ...
              <section id="law">
                ...
                <p className="mb-4">
                  ...
                  the laws of India. Deforge and yourself irrevocably consent
              ...
              <section id="disputes">
                ...
                <p className="mb-4">
                  ...
                  Kolkata, India. The language of the proceedings shall be
              ...
              <section id="liability">
                ...
                <p className="mb-4">
                  ...
                  AMOUNT PAID, IF ANY, BY YOU TO US DURING THE FOUR (4) MONTH
