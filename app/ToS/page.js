    ...
    <Container className="py-12 md:py-20 px-4 sm:px-20 relative">
      <div className="prose prose-neutral max-w-4xl mx-auto prose-headings:font-bold prose-h1:text-4xl prose-h2:text-2xl prose-h3:text-xl prose-a:text-blue-600 hover:prose-a:text-blue-800 prose-ul:list-disc prose-li:marker:text-black/50">
        <div className="text-center mb-12 border-b border-dashed border-black/20 pb-12">
          ...
          <p className="text-muted-foreground">Last updated: August 06, 2025</p>
        </div>

        <div className="space-y-8 text-black/80 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-black mb-4" id="agreement">
            ...
            <p className="mb-4">
              We provide a node based visual editor for creating and deploying
              AI agents.
            </p>
            ...
            <p className="mb-4">
              ...
              <strong>you</strong>"), and Deforge, concerning your access to and
            ...
            <p className="mb-4">
              ...
              effective upon posting or notifying you by support@deforge.io, as
          ...
          <section id="ip">
            ...
            <p className="mb-4">
              ...
              Terms, please address your request to: contact@deforge.io. If we
          ...
          <section id="userreps">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>
                (8) your use of the Services will not violate any applicable law
                or regulation.
              </li>
            </ul>
          ...
          <section id="law">
            ...
            <p className="mb-4">
              ...
              laws of India. Deforge and yourself irrevocably consent that the
          ...
          <section id="disputes">
            ...
            <p className="mb-4">
              ...
              or arbitration shall be Kolkata, India. The language of the
          ...
          <section id="liability">
            ...
            <p className="mb-4">
              ...
              PAID, IF ANY, BY YOU TO US DURING THE FOUR (4) MONTH PERIOD PRIOR
