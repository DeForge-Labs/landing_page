const templateData = [
  ...
  {
    id: "dc10c5d2-0d51-4eb6-b9f0-94ddb38522a4",
    name: "Automated AI Video to YouTube",
    description: "An automated system that will periodically search the internet for a given query and generate a video from the content it finds using Veo3. The generated video is then uploaded to the users connected YouTube account.",
    content": "# Description\n## What It Does ?\n- Uses cron trigger to periodically run the workflow after a set amount of time.\n- Searches across the internet to find articles about your query\n- Automatically generates prompt for video generation\n- Also generates metadata for Youtube:\n  - Title\n  - Description\n  - Tags\n- Uploads video to your connected YouTube account\n\n## What do you have to do ?\n- Set the time interval for your workflow run in the `Cron Trigger` node.\n- Set the search query in the `AI Web Search` Node.\n- Select the `YouTube` node and check out the node details in right panel. Edit category and privacy of the video.\n- In the same panel, use the connect button to connect your YouTube account.\n- Deploy the workflow.\n\n## Use Cases:\n- Automatically upload videos and grow your channel.\n- Generate and store videos in bulk",
    tags: ["Veo", "YouTube", "Periodic"],
    category: "Generator",
    author: "Team Deforge",
    workflowId: "5fbd5c01-b955-430a-ae5f-e531831a2f2a",
    createdAt: "2025-07-14T19:15:45.103Z",
    updatedAt: "2025-07-14T19:15:45.103Z",
    workflow: {
      id: "5fbd5c01-b955-430a-ae5f-e531831a2f2a",
      name: "Automatic AI Video to YouTube",
      createdAt: "2025-07-06T19:48:31.427Z",
      updatedAt: "2025-07-07T12:32:57.219Z",
      teamId: "8e91e769-a108-4905-88ca-b74a7e80cd57",
      version: 4,
      status: "TEST",
      _count: {
