export const templates = [
  {
    ...
    tags: ["chatbot", "support", "widget", "RAG", "knowledge base", "AI"],
    nodes: [
      "Widget Trigger",
      "Knowledge Base",
      "Google Chat",
      "Send Widget Response",
    ],
  },
  {
    id: 2,
  ...
  {
    id: 7,
    name: "Telegram Voice Note Transcriber",
    description:
      "A handy Telegram bot that transcribes any voice message you send it. It uses a Speech-to-Text model to convert the audio into text and sends the transcription back to you, perfect for saving notes or meetings.",
    category: "Audio & Transcription",
    tags: ["telegram", "bot", "audio", "transcription", "speech to text"],
    nodes: ["Telegram Trigger", "Speech To Text", "Send Telegram Message"],
  },
  {
    id: 8,
